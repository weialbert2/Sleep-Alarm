...
const footerLinks = {
  shop: {
    title: "Shop",
    links: [
      { label: "1 Kit — $59.97", href: "#order" },
      { label: "2 Kit — $99.97", href: "#order" },
      { label: "3 Kit — $139.97", href: "#order" },
      { label: "Gallon Kit — $239.97", href: "#order" },
    ],
  },
  support: {
    title: "Support",
  ...
  company: {
    title: "Company",
    links: [
      { label: "About MAXL ONE", href: "/pages/about" },
...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://instagram.com/maxlone",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/maxlone",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@maxlone",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-[#1A1A1A] border-b border-[#333]">
        <div className="container-site py-10">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <h3 className="text-lg font-bold text-white mb-1">Get Exclusive MAXL ONE Offers</h3>
              <p className="text-sm text-[#aaa]">Tips, product updates, and special discounts — direct to your inbox.</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-[#aaa] leading-relaxed mb-6">
              The all-purpose clean, shine, and protect spray.
              <br />
              Make everything look NEW again — effortlessly.
            </p>
            {/* Social icons */}
      ...
      <div className="border-t border-[#333]">
        <div className="container-site py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <p className="text-xs text-[#666]">
            © {new Date().getFullYear()} MAXL ONE. All rights reserved.
          </p>
